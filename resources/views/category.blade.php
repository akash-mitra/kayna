	 ...
	 viewBox="0 0 512 512" style="enable-background:new 0 0 512 512;" xml:space="preserve">
        ...
        <div class="w-full pattern text-white rounded-lg p-10 overflow-scroll">
            <div class="max-w-4xl text-center">
                ...
                <header>
                        ...
                        <div class="w-full text-sm text-indigo-200 mb-4">{{ $resource->parent->name }}</div>
                        @endif
        ...
        <main>
            ...
            @if(count($resource->subcategories))
                ...
                <h3 class="mt-10 pb-4 text-sm uppercase text-gray-700 text-center pb-4 border-b">Sub-Categories</h3>

                <div class="flex flex-wrap">
                @foreach($resource->subcategories as $category)
                        <div class="bg-gray-100 shadow rounded p-4 m-2">
                            <a href="{{ $category->url }}" class="text-indigo-700 font-bold">{{ $category->name }}</a>
                        </div>
                @endforeach
                </div>
            ...
            @if(count($resource->pages))
                <h3 class="mt-10 text-sm uppercase text-gray-700 text-center pb-4 border-b">Pages</h3>
