    ...
    <table class="w-full bg-white shadow rounded text-left table-collapse">
        ...
        <tbody class="align-baseline">
            <tr v-for="tag in filter_tags">
                ...
                <td class="px-4 py-2 border-t border-grey-light">

                    <p class="py-1 text-sm font-semibold whitespace-no-wrap" v-text="tag.name"></p>
                    <p class="text-xs text-grey-darker" v-text="tag.description"></p>

                </td>
                <td class="hidden sm:table-cell px-4 py-2 border-t border-grey-light font-mono text-xs text-purple-dark whitespace-no-wrap">
                    10
                </td>
                <td class="hidden sm:table-cell px-4 py-2 border-t border-grey-light font-mono text-xs text-purple-dark whitespace-no-wrap" v-text="tag.ago">
                </td>
