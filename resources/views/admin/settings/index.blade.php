...
<div class="pt-4 flex flex-cols border-b">
    ...
    <div class="w-48 uppercase text-sm font-bold border-t">
        ...
        <div :class="active_tab!=6? 'cursor-pointer text-grey-dark':'text-indigo-dark bg-white border-l-2 border-indigo'" class="py-4 pl-8" @click="select('mail', $event)">Mail</div>
        <div :class="active_tab!=7? 'cursor-pointer text-grey-dark':'text-indigo-dark bg-white border-l-2 border-indigo'" class="py-4 pl-8" @click="select('feed', $event)">Feeds</div>
    </div>
    ...
    <div v-show="active_tab===7" class="w-full md:flex text-sm bg-white border-t">
...
<script>
    new Vue({
        ...
        data: {
            active_tab: 6,
            tabs: ['general', 'social', 'storage', 'editor', 'cache', 'mail', 'feed'],
