...
<div class="px-6 py-4">
    ...
    <div v-show="active_tab===1" class="w-full md:flex text-sm bg-white shadow">
    ...
    <div v-show="active_tab===2" class="w-full flex flex-wrap text-sm px-2 p-4 bg-white shadow">

        <div class="w-full">
            <div class="w-full border-b px-8 py-4 mb-2 text-indigo-dark font-light text-lg">Amazon Web Services - S3</div>
