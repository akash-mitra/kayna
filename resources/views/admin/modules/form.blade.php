...
<div class="w-full px-6">
        ...
        <div class="my-4 px-6 py-4 text-green-dark bg-green-lightest border border-green w-2/3 rounded hidden" id="flash-msg"></div>
        ...
        <div class="mt-4 w-full md:w-4/5 lg:w-3/5  p-6 bg-white shadow bordesr rounded-lg">
                <div class="flex flex-wrap -mx-3 mb-6">
                        <div class="w-full px-3">
                                ...
                                <div id="editor" class="appearance-none block w-full h-64  border border-grey-lighter rounded py-3 px-4 mb-3 leading-tight focus:outline-none">{{ data_get($module, 'code') }}</div>
        ...
        let confirm = function() {
                ...
                updateAtServer = function() {
                        ...
                        axios.patch('/admin/modules/' + data.id, {
                                ...
                                let span = document.getElementById('flash-msg')
                                span.innerText = response.data.flash.message
