    ...
    <div class="w-full max-w-5xl mx-auto px-6 font-reading">
	 ...
	 viewBox="0 0 512 512" style="enable-background:new 0 0 512 512;" xml:space="preserve">
        ...
        <div class="w-full pattern text-white rounded-lg p-10 overflow-scroll">
            <div class="max-w-4xl">
                <h3 class="text-5xl text-indigo-100 font-heading font-bold italic leading-tight">{{ $resource->pages[0]->title }}</h3>
                <p class="py-4 text-lg text-indigo-200">{{ $resource->pages[0]->summary }}</p>
                <a href="{{ $resource->pages[0]->url }}" class="text-white font-bold">Continue Reading...</a>
            </div>
        </div>
                ...
                <section class="w-full md:w-1/2 p-4">
                    ...
                    <header>
                        <h2 class="my-2 font-heading text-3xl">
                            <a href="{{ $item->url }}" class="text-indigo-700 leading-tight hover:text-blue-500">
                                {{ $item->title }}
                            </a>
                        </h2>
                    </header>
                    ...
                    <footer>
                        <div class="text-xs mt-4 text-indigo-500">
