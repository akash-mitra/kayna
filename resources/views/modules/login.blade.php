...
<a href="{{ auth()->user()->url }}">
    ...
    <svg v-else class="w-10 h-10 rounded-full border-4 mr-4 fill-current text-grey-500" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="24" height="24">
...
@endauth
@guest
<a href="/login" class="text-indigo-600 no-underline text-sm">
    Register / Login
</a>
@endguest
@endif