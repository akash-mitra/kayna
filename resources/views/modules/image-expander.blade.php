<div class="fixed top-0 left-0 w-full h-full flex justify-center items-center overflow-auto" style="background: rgba(0,0,0, 0.75); display: none" id="img-overlay">
            <img id="modal-image" class="max-w-full w-full1" src="#" />
</div>
